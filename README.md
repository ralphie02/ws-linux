- One-liner
    ...
    VARS='GIT_CONF_EMAIL=edit@me.com GIT_CONF_NAME="<edit me>" RAILS_VER=latest RUBY_VER=latest NODE_VER=lts' && wget -O- https://raw.githubusercontent.com/ralphie02/ws-linux/master/_Init.md | sed '$ d' | sed '1,1d' | sed "/\#\!.*bash$/a \\\n$VARS" | bash
